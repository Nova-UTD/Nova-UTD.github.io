...
# Roll With Us!
We're Nova, UT Dallas's applied autonomous driving project. We aim to create the first open-source, modular, autonomous driving platform in Texas-- period. We've already come a long way, but we need your help to go further than ever.
...
### ___Developer___
Developers work on the heart of our robot. They don't just write code, but also engineer the algorithms that drive our whole system (no pun intended). Everything from sensor processing to behavior planning to object tracking is formed and improved by this group. If you love robotics, artificial intelligence, controls, machine vision, Nova presents a unique opportunity to combine them all to create something amazing.
#### <u>Qualifications</u>:
...
- **Time Commitment**
    ...
    - Nova should be your top priority outside of class
...
<iframe src="https://utdallas.app.box.com/f/65b64ee2586240ec965e0e2e72ac930e" height="550" width="500"></iframe>
